...
// Custom serde module for proper double-optional handling in livelihood updates
mod double_option_livelihood {
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'de> Visitor<'de> for DoubleOptionVisitor {
            ...
            where
                E: Error,
            {
                println!("🔧 [LIVELIHOOD_SERDE] visit_none - field missing");
                Ok(None)
            }
            ...
            where
                E: Error,
            {
                println!("🔧 [LIVELIHOOD_SERDE] visit_unit - field is null");
                Ok(Some(None))
            }
            ...
            where
                E: Error,
            {
                println!("🔧 [LIVELIHOOD_SERDE] visit_str - field has UUID string");
...
pub struct UpdateLivelihood {
    #[serde(skip_serializing_if = "Option::is_none", deserialize_with = "double_option_livelihood::deserialize")]
